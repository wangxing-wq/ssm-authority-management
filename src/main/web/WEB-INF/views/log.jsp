                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="dataTables_length" id="dynamic-table_length"><label>
                                        ...
                                        <input id="search-operator" type="search" name="operator"
                                               class="form-control input-sm" placeholder="操作者"
                                               aria-controls="dynamic-table">
                                        <input id="search-before" type="search" name="beforeSeg"
                                               class="form-control input-sm" placeholder="操作前的值"
                                               aria-controls="dynamic-table">
                                        <input id="search-after" type="search" name="afterSeg"
                                               class="form-control input-sm" placeholder="操作后的值"
                                               aria-controls="dynamic-table">
                                        <input id="search-from" type="search" name="fromTime"
                                               class="form-control input-sm" placeholder="开始时间"
                                               aria-controls="dynamic-table"> ~
            ...
            <script type="text/javascript">
                $(function () {
                    ...
                    function loadLogList() {
                        ...
                        let pageNo = $("#logPage .pageNo").val() || 1;
                        let url = "/sys/log/page.json";
                        let beforeSeg = $("#search-before").val();
                        let afterSeg = $("#search-after").val();
                        let operator = $("#search-operator").val();
                        let fromTime = $("#search-from").val();
                        let toTime = $("#search-to").val();
