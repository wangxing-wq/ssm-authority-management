            ...
            <form id="deptForm">
                <table class="table table-striped table-bordered table-hover dataTable no-footer" role="grid">
                    ...
                    <tr>
                        ...
                        <td><textarea name="remark" id="deptRemark" class="text ui-widget-content ui-corner-all"
            ...
            <form id="userForm">
                <table class="table table-striped table-bordered table-hover dataTable no-footer" role="grid">
                    ...
                    <tr>
                        ...
                        <td><textarea name="remark" id="userRemark" class="text ui-widget-content ui-corner-all"
                                      rows="3" cols="25"></textarea></td>
                    </tr>
                </table>
            </form>
                            ...
                            buttons: {
                                "更新": function (e) {
                                    ...
                                    updateDept(false, function (data) {
                                        ...
                                        showMessage("更新部门", data.data, false);
                                    })
                                },
                                "取消": function () {
                                    $("#dialog-dept-form").dialog("close");
                        ...
                        buttons: {
                            "添加": function (e) {
                                ...
                                updateUser(true, function (data) {
                                    ...
                                    showMessage("新增用户", data.data, false);
                                })
                            },
                            "取消": function () {
                                $("#dialog-user-form").dialog("close");
                            ...
                            buttons: {
                                "更新": function (e) {
                                    ...
                                    updateUser(false, function (data) {
                                        ...
                                        showMessage("更新用户", data.data, false);
                                    })
                                },
                                "取消": function () {
                                    $("#dialog-user-form").dialog("close");
                        ...
                        buttons: {
                            "添加": function (e) {
                                ...
                                updateDept(true, function (data) {
                                    ...
                                    showMessage("新增部门", data.data, false);
                                })
                            },
                            "取消": function () {
                                $("#dialog-dept-form").dialog("close");
